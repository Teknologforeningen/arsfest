    ...
    <>
      <div className="w-[90%] lg:w-[80%] 2xl:w-[70%] my-2 mx-auto">
        ...
        <div className="mt-4">
          ...
          <h2 className="text-2xl mb-2 underline">Klädkod</h2>
          <p className="mb-2">
          ...
          <p className="mb-5"><i>*Anges ingen klädkod kan man anta att klädseln är fri men sannolikt ändå obligatorisk.
          ...
          <h2 className="text-2xl mb-2 underline">Årsfestens olika skeden </h2>
          ...
          <h2 className="text-2xl underline mb-2">Sångkultur på TF:s årsfest</h2>
          <p className="mb-3">
