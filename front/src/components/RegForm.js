...
//           </label>
//           <textarea className='bg-inherit border border-[#C0C0C0] focus:ring-[#C0C0C0] text-sm rounded-lg block w-full p-2.5 hover:text-[#ceb886] hover:border-[#ceb886] focus:border-[#ceb886] focus:outline-none'
...
const RegInfo = () => {
  return (
    <>
      <h2 className="text-3xl mb-5">Deltagaranmälan</h2>
      <p className="text-xl ">Inbjudna gäster</p>
      <p className="mb-5">
        Anmälan för inbjudna gäster öppnar den 24 januari klockan 12 och stänger 9 februari klockan 18.
      </p>
      <p className="mb-16">
        Länk till inbjudna gästers anmälan:
        <a href="https://evenemang.tf.fi/events/TF152inbjudna" className="ml-2 underline" target="_blank">
          https://evenemang.tf.fi/events/TF152inbjudna
        </a>
      </p>
      <p className="text-xl ">Övriga gäster</p>

      <p className="mb-4">
        Den öppna anmälan för nationsmedlemmar, alumner, avecer och övriga gäster öppnar den 12 februari klockan 12 och stänger senast 16 februari klockan 18.
        Vänligen observera att avecer bör fylla i sin egen anmälan.
      </p>
      <p className="mb-3">
        Länk till övriga gästers anmälan:
        <a href=" https://evenemang.tf.fi/events/TF152ovriga" className="ml-2 underline" target="_blank">
          https://evenemang.tf.fi/events/TF152ovriga
        </a>
      </p>
