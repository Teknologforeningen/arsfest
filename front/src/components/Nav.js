    ...
    return (
      <li key={page.href}>
        {activePage === page.href ? (
          <a
            href={page.href}
            className="block py-2 pl-3 pr-4 text-[#011b17] bg-[#C0C0C0] rounded md:bg-transparent md:text-[#C0C0C0] md:text-[#757575] md:p-0"
            aria-current="page"
          >
            {page.text}
          </a>
          ...
          <a
            href={page.href}
            className="block py-2 pl-3 pr-4 text-[#C0C0C0] rounded hover:bg-[#C0C0C0] hover:text-[#011b17] md:hover:bg-transparent md:border-0 md:hover:text-[#C0C0C0] md:hover:text-[#757575] md:p-0"
          >
            {page.text}
          </a>
        )}
