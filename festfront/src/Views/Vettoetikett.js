...
const Vettoetikett = () => {
    ...
    <div class="center-page">
        ...
        <div class="page-content-container"> 
            ...
            <h2 class="page-content-title">Vett och etikett</h2>
            <h2><b>Klädkod</b></h2>
            ...
            <p class="page-content-text"><i>*Anges ingen klädkod kan man anta att klädseln är fri men sannolikt ändå obligatorisk. 
                Kanske värt att kolla med värden?</i></p>
            
            <h4><b>Frack</b></h4>
            <p class="page-content-list">
            ...
            <ul>
                ...
                i rockens vänstra insida eller i vänster hängselstropp och löper diskret ned i vänster byxficka. Kedjan bör inte löpa över frackvästen. <br/><br/>
                </li>
            </ul>
            ...
            <h4><b>Kår- eller nationsband</b></h4>
            <p class="page-content-text">
